                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="codigo"
                                                placeholder="Codigo Planta" value="{{$planta->codigo}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nombre"
                                                placeholder="Nombre Planta" value="{{$planta->nombre}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ubicacion"
                                                placeholder="Ubicación" value="{{$planta->ubicacion}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
