...
<div class="content-wrapper pt-3">
    ...
    <div class="content">
        ...
        <div class="col-md-6 float-left">
            <div class="input-group col-md-8 float-left">
                ...
                <form style="display: contents !important;margin-top: 0em !important;margin-block-end: 0em !important">
                    ...
                    placeholder="Buscar Nombre Sub-Categoria" aria-label="Search" style="width: 65% !important;">&nbsp;&nbsp;
        ...
        <div class="float-right">
            <a href="{{ route('sub-categorias.create')}}"><button class="btn btn-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a href="{{ route('sub-categorias.edit',$subcategorias->id ) }}">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i> Editar
                                </button></a> 
                            <form action="{{ route('sub-categorias.destroy',$subcategorias->id ) }}" method="POST"
